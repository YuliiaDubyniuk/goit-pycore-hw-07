...
from book_records import AddressBook, Record, Phone, Name, Birthday
import utilities
...
def add_contact_birthday(book: AddressBook, args: list):
...
@input_error
def handle_command(book: AddressBook, command: str, args: list):
